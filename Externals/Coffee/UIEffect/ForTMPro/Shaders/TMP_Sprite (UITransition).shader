Shader "TextMeshPro/Sprite (UITransition)"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			#define ADD 1
            #include "Packages/.Module.UnityCommonExternals@2.0.6/Externals/Coffee/UIEffect/Shaders/UI-Effect.cginc"
            #include "Packages/.Module.UnityCommonExternals@2.0.6/Externals/Coffee/UIEffect/Shaders/UI-Effect-Sprite.cginc"
