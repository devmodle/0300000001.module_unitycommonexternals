Shader "TextMeshPro/Sprite (UIDissolve)"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			#define DISSOLVE 1
            #include "Packages/.Module.UnityCommonExternals@2.1.9/Externals/Coffee/UIEffect/Shaders/UI-Effect.cginc"
            #include "Packages/.Module.UnityCommonExternals@2.1.9/Externals/Coffee/UIEffect/Shaders/UI-Effect-Sprite.cginc"
