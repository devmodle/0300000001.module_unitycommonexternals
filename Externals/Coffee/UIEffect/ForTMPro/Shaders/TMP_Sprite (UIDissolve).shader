Shader "TextMeshPro/Sprite (UIDissolve)"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			#define DISSOLVE 1
            #include "Packages/.Module.UnityCommonExternals@2.1.5/Externals/Coffee/UIEffect/Shaders/UI-Effect.cginc"
            #include "Packages/.Module.UnityCommonExternals@2.1.5/Externals/Coffee/UIEffect/Shaders/UI-Effect-Sprite.cginc"
