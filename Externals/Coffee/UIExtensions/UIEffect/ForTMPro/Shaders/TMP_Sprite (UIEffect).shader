Shader "TextMeshPro/Sprite (UIEffect)"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			#define TMP_SPRITE 1
			#define UI_EFFECT 1
            #include "Packages/.Module.UnityCommonExternals@1.7.3/Externals/Coffee/UIExtensions/UIEffect/Shaders/UI-Effect.cginc"
            #include "Packages/.Module.UnityCommonExternals@1.7.3/Externals/Coffee/UIExtensions/UIEffect/Shaders/UI-Effect-Sprite.cginc"
