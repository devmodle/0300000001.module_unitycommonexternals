Shader "TextMeshPro/Sprite (UIEffect)"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			#define TMP_SPRITE 1
			#define UI_EFFECT 1
            #include "Packages/.UnityModule.Common.Externals@1.5.6/Externals/Coffee/UIExtensions/UIEffect/Shaders/UI-Effect.cginc"
            #include "Packages/.UnityModule.Common.Externals@1.5.6/Externals/Coffee/UIExtensions/UIEffect/Shaders/UI-Effect-Sprite.cginc"
